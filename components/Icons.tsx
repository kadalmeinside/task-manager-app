...
export const GoogleDriveIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M7.71,3.5,1.15,15.29a0.75,0.75,0,0,0,.69,1.14H22.16a0.75,0.75,0,0,0,.69-1.14L16.29,3.5a0.75,0.75,0,0,0-1.38,0L9.09,12.75l-4.5-8.66a0.75,0.75,0,0,0-1.38.72L8.4,14.5,15,3l-3.23,6.19-4.06-6.69Z"></path>
    </svg>
);
...
export const BellPlusIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path>
    <path d="M13.73 21a2 2 0 0 1-3.46 0"></path>
    <path d="M18 2v4"></path>
